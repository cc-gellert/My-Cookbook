...
function Home() {
  return (
    <div className="Home">
      ...
      <p className="lead">An app for collecting recipes, menu planning, and grocery list making, built with React and Bootstrap</p>
      <img src={homeimage} style={{ width: '90%' }} alt='Cook stirring vegetables in a hot pan' />
